...
1. [Go](https://golang.org/doc/install) version 1.20 (Notes: make init generate `generated/api.gen.go` file that using `github.com/getkin/kin-openapi` and it requires Go version 1.20)
